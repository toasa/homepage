    ...
    <div class="article">
        ...
        <div class="section">
            ...
            <p>原因: パトリオットミサイルのシステムは、内部クロックとして0.1秒ごとにインクリメントするカウンタ
                を採用した。0.1を2進数で表すと循環小数になり、どこかで数を丸める必要がある（実際は仮数部を23bitで保持していた）。
                丸めから生じる誤差は、システム起動から100時間後になると、実時間と比べおよそ0.34秒になった。
                迎撃システムの性質上、長時間連続して可動させかつ、正確な計算が求められるのだろう。0.34秒という誤差は致命的だった。
        ...
        <div class="section">
            ...
            <p>興味はあるが、費やす時間は数k時間になりそうで二の足。</p>
        </div>
    </div>
